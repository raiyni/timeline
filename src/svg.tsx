...
export const Shape = ({ options }: { options: ShapeOptions }) => {
  switch (options.shape) {
        ...
        <g transform="translate(10, 10)">
          <g transform={`rotate(${options.rotate || 0})`}>
            <rect
              ...
              height={18}
              style={options.style}
              transform={`translate(-10, -10) skewX(${options.skew ? options.skew : 0})`}
            ></rect>
          </g>
        </g>
      )
    ...
    case ShapeType.STAR:
      return <polygon style={options.style} points="10,1 12,8, 19,8, 13.5,12 15.5,19 10,15, 4.5,19 6.5,12 1,8 8,8"></polygon>
  }
